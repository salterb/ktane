...
MAZE_1_VALID_MOVES = {(1,1): [UP, RIGHT], (2,1): [LEFT], (3,1): [UP, RIGHT],
...
MAZE_2_VALID_MOVES = {(1,1): [UP], (2,1): [UP, RIGHT], (3,1): [LEFT, UP],
...
MAZE_3_VALID_MOVES = {(1,1): [RIGHT, UP], (2,1): [LEFT, RIGHT],
...
MAZE_4_VALID_MOVES = {(1,1): [RIGHT, UP], (2,1): [LEFT, RIGHT], (3,1): [LEFT],
...
MAZE_5_VALID_MOVES = {(1,1): [UP], (2,1): [UP, RIGHT], (3,1): [LEFT, RIGHT],
...
MAZE_6_VALID_MOVES = {(1,1): [RIGHT, UP], (2,1): [LEFT, RIGHT],
...
MAZE_7_VALID_MOVES = {(1,1): [RIGHT, UP], (2,1): [LEFT, RIGHT],
...
MAZE_8_VALID_MOVES = {(1,1): [RIGHT, UP], (2,1): [LEFT, UP, RIGHT],
                      (3,1): [LEFT, RIGHT], (4,1): [LEFT, RIGHT],
...
MAZE_9_VALID_MOVES = {(1,1): [UP, RIGHT], (2,1): [LEFT, UP], (3,1): [UP, RIGHT],
...
MAZE_LOOKUP = {(1,5): MAZE_1_VALID_MOVES, (6,4): MAZE_1_VALID_MOVES,
               (2,3): MAZE_2_VALID_MOVES, (5,5): MAZE_2_VALID_MOVES,
               (4,3): MAZE_3_VALID_MOVES, (6,3): MAZE_3_VALID_MOVES,
               (1,3): MAZE_4_VALID_MOVES, (1,6): MAZE_4_VALID_MOVES,
               (4,1): MAZE_5_VALID_MOVES, (5,4): MAZE_5_VALID_MOVES,
               (3,2): MAZE_6_VALID_MOVES, (5,6): MAZE_6_VALID_MOVES,
               (2,1): MAZE_7_VALID_MOVES, (2,6): MAZE_7_VALID_MOVES,
               (3,3): MAZE_8_VALID_MOVES, (4,6): MAZE_8_VALID_MOVES,
               (1,2): MAZE_9_VALID_MOVES, (3,5): MAZE_9_VALID_MOVES}

def maze_input(string):
    return input(string).strip('()[] ')


def _DFS_maze_helper(maze, player_pos, end, current_moves):
    ...
    for move in M[tuple(player_pos)]:
        ...
        if len(current_moves) == 0 or move != -current_moves[-1]:
            ...
            possible_moves = _DFS_maze_helper(maze, new_pos, end, new_moves)
...
def DFS_maze(maze, start, end):
    ...
    return _DFS_maze_helper(maze, list(start), list(end), [])
...
def solve_maze():
    ...
    while True:
        ...
        if (len(maze_ipt) >= 2 and
            (int(maze_ipt[0]), int(maze_ipt[-1])) in MAZE_LOOKUP.keys()):
                break
